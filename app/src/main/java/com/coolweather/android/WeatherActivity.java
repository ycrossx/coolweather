...
public class WeatherActivity extends AppCompatActivity {
    ...
    public void requestWeather(String weatherId) {
        loadBingPic();
        String weatherUrl = "http://guolin.tech/api/weather?cityid="+weatherId+"&key=cbaae2d6dbd541f39b5da0a8c8d7ad0d";
    ...
    private void showWeatherInfo(Weather weather) {
        ...
        for (Forecast forecast : weather.forcastList) {
            View view = getLayoutInflater().from(this).inflate(R.layout.forecast_item,forecastlayout,false);
            TextView dateText = (TextView) view.findViewById(R.id.date_text);
            TextView infoText = (TextView) view.findViewById(R.id.infor_text);
